...
1. Write the JSON schema describing your resource, `awssamples-ec2ssmsmonly-hook.json`
2. Implement your resource handlers in `awssamples_ec2ssmsmonly_hook/handlers.py`

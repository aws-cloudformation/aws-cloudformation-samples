...
@dataclass
class AwsCodestarconnectionsConnection(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsCodestarconnectionsConnection"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsCodestarconnectionsConnection"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            HostArn=json_data.get("HostArn"),
            Tags=json_data.get("Tags"),
        )


# work around possible type aliasing issues when variable has same name as a model
_AwsCodestarconnectionsConnection = AwsCodestarconnectionsConnection

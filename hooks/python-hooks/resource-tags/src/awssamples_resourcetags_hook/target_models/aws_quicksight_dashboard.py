...
@dataclass
class AwsQuicksightDashboard(BaseModel):
    Arn: Optional[str]
    AwsAccountId: Optional[str]
    CreatedTime: Optional[str]
    DashboardId: Optional[str]
    DashboardPublishOptions: Optional["_DashboardPublishOptions"]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsQuicksightDashboard"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsQuicksightDashboard"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            DashboardPublishOptions=DashboardPublishOptions._deserialize(json_data.get("DashboardPublishOptions")),
...
_AwsQuicksightDashboard = AwsQuicksightDashboard


@dataclass
class DashboardPublishOptions(BaseModel):
    AdHocFilteringOption: Optional["_AdHocFilteringOption"]
    ExportToCSVOption: Optional["_ExportToCSVOption"]
    SheetControlsOption: Optional["_SheetControlsOption"]
    VisualPublishOptions: Optional["_DashboardVisualPublishOptions"]
    SheetLayoutElementMaximizationOption: Optional["_SheetLayoutElementMaximizationOption"]
    VisualMenuOption: Optional["_VisualMenuOption"]
    VisualAxisSortOption: Optional["_VisualAxisSortOption"]
    ExportWithHiddenFieldsOption: Optional["_ExportWithHiddenFieldsOption"]
    DataPointDrillUpDownOption: Optional["_DataPointDrillUpDownOption"]
    DataPointMenuLabelOption: Optional["_DataPointMenuLabelOption"]
    DataPointTooltipOption: Optional["_DataPointTooltipOption"]

    @classmethod
    def _deserialize(
        cls: Type["_DashboardPublishOptions"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DashboardPublishOptions"]:
        if not json_data:
            return None
        return cls(
            AdHocFilteringOption=AdHocFilteringOption._deserialize(json_data.get("AdHocFilteringOption")),
            ExportToCSVOption=ExportToCSVOption._deserialize(json_data.get("ExportToCSVOption")),
            SheetControlsOption=SheetControlsOption._deserialize(json_data.get("SheetControlsOption")),
            VisualPublishOptions=DashboardVisualPublishOptions._deserialize(json_data.get("VisualPublishOptions")),
            SheetLayoutElementMaximizationOption=SheetLayoutElementMaximizationOption._deserialize(json_data.get("SheetLayoutElementMaximizationOption")),
            VisualMenuOption=VisualMenuOption._deserialize(json_data.get("VisualMenuOption")),
            VisualAxisSortOption=VisualAxisSortOption._deserialize(json_data.get("VisualAxisSortOption")),
            ExportWithHiddenFieldsOption=ExportWithHiddenFieldsOption._deserialize(json_data.get("ExportWithHiddenFieldsOption")),
            DataPointDrillUpDownOption=DataPointDrillUpDownOption._deserialize(json_data.get("DataPointDrillUpDownOption")),
            DataPointMenuLabelOption=DataPointMenuLabelOption._deserialize(json_data.get("DataPointMenuLabelOption")),
            DataPointTooltipOption=DataPointTooltipOption._deserialize(json_data.get("DataPointTooltipOption")),
        )


# work around possible type aliasing issues when variable has same name as a model
_DashboardPublishOptions = DashboardPublishOptions
...
class AdHocFilteringOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AdHocFilteringOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AdHocFilteringOption"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AdHocFilteringOption = AdHocFilteringOption
...
class ExportToCSVOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ExportToCSVOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ExportToCSVOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_ExportToCSVOption = ExportToCSVOption


@dataclass
class SheetControlsOption(BaseModel):
    VisibilityState: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_SheetControlsOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SheetControlsOption"]:
        if not json_data:
            return None
        return cls(
            VisibilityState=json_data.get("VisibilityState"),
        )


# work around possible type aliasing issues when variable has same name as a model
_SheetControlsOption = SheetControlsOption


@dataclass
class DashboardVisualPublishOptions(BaseModel):
    ExportHiddenFieldsOption: Optional["_ExportHiddenFieldsOption"]

    @classmethod
    def _deserialize(
        cls: Type["_DashboardVisualPublishOptions"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DashboardVisualPublishOptions"]:
        if not json_data:
            return None
        return cls(
            ExportHiddenFieldsOption=ExportHiddenFieldsOption._deserialize(json_data.get("ExportHiddenFieldsOption")),
        )


# work around possible type aliasing issues when variable has same name as a model
_DashboardVisualPublishOptions = DashboardVisualPublishOptions
...
class ExportHiddenFieldsOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ExportHiddenFieldsOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ExportHiddenFieldsOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_ExportHiddenFieldsOption = ExportHiddenFieldsOption
...
class SheetLayoutElementMaximizationOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SheetLayoutElementMaximizationOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SheetLayoutElementMaximizationOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_SheetLayoutElementMaximizationOption = SheetLayoutElementMaximizationOption
...
class VisualMenuOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VisualMenuOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VisualMenuOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_VisualMenuOption = VisualMenuOption
...
class VisualAxisSortOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VisualAxisSortOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VisualAxisSortOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_VisualAxisSortOption = VisualAxisSortOption
...
class ExportWithHiddenFieldsOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ExportWithHiddenFieldsOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ExportWithHiddenFieldsOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_ExportWithHiddenFieldsOption = ExportWithHiddenFieldsOption
...
class DataPointDrillUpDownOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DataPointDrillUpDownOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DataPointDrillUpDownOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_DataPointDrillUpDownOption = DataPointDrillUpDownOption
...
class DataPointMenuLabelOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DataPointMenuLabelOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DataPointMenuLabelOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_DataPointMenuLabelOption = DataPointMenuLabelOption
...
class DataPointTooltipOption(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DataPointTooltipOption"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DataPointTooltipOption"]:
        if not json_data:
            return None
        return cls(
            AvailabilityStatus=json_data.get("AvailabilityStatus"),
...
# work around possible type aliasing issues when variable has same name as a model
_DataPointTooltipOption = DataPointTooltipOption


@dataclass
class DashboardVersionDefinition(BaseModel):
    DataSetIdentifierDeclarations: Optional[Sequence["_DataSetIdentifierDeclaration"]]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DashboardVersionDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DashboardVersionDefinition"]:
        if not json_data:
            return None
        return cls(
            DataSetIdentifierDeclarations=deserialize_list(json_data.get("DataSetIdentifierDeclarations"), DataSetIdentifierDeclaration),
...
# work around possible type aliasing issues when variable has same name as a model
_DashboardVersionDefinition = DashboardVersionDefinition
...
class DataSetIdentifierDeclaration(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DataSetIdentifierDeclaration"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DataSetIdentifierDeclaration"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_DataSetIdentifierDeclaration = DataSetIdentifierDeclaration
...
class Parameters(BaseModel):
    ...
    DecimalParameters: Optional[Sequence["_DecimalParameter"]]
    DateTimeParameters: Optional[Sequence["_DateTimeParameter"]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            StringParameters=deserialize_list(json_data.get("StringParameters"), StringParameter),
            IntegerParameters=deserialize_list(json_data.get("IntegerParameters"), IntegerParameter),
            DecimalParameters=deserialize_list(json_data.get("DecimalParameters"), DecimalParameter),
            DateTimeParameters=deserialize_list(json_data.get("DateTimeParameters"), DateTimeParameter),
        )
...
class StringParameter(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_StringParameter"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_StringParameter"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
class IntegerParameter(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IntegerParameter"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IntegerParameter"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
class DecimalParameter(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DecimalParameter"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DecimalParameter"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
# work around possible type aliasing issues when variable has same name as a model
_DecimalParameter = DecimalParameter
...
class DateTimeParameter(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DateTimeParameter"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DateTimeParameter"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
# work around possible type aliasing issues when variable has same name as a model
_DateTimeParameter = DateTimeParameter
...
class DashboardSourceEntity(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DashboardSourceEntity"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DashboardSourceEntity"]:
        if not json_data:
            return None
        return cls(
            SourceTemplate=DashboardSourceTemplate._deserialize(json_data.get("SourceTemplate")),
        )


# work around possible type aliasing issues when variable has same name as a model
_DashboardSourceEntity = DashboardSourceEntity
...
class DashboardSourceTemplate(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DashboardSourceTemplate"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DashboardSourceTemplate"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_DashboardSourceTemplate = DashboardSourceTemplate
...
class DashboardVersion(BaseModel):
    CreatedTime: Optional[str]
    Errors: Optional[Sequence["_DashboardError"]]
    VersionNumber: Optional[float]
    Status: Optional[str]
    Arn: Optional[str]
    SourceEntityArn: Optional[str]
    DataSetArns: Optional[Sequence[str]]
    Description: Optional[str]
    ThemeArn: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DashboardVersion"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DashboardVersion"]:
        if not json_data:
            return None
        return cls(
            CreatedTime=json_data.get("CreatedTime"),
            Errors=deserialize_list(json_data.get("Errors"), DashboardError),
            VersionNumber=json_data.get("VersionNumber"),
            Status=json_data.get("Status"),
            Arn=json_data.get("Arn"),
            SourceEntityArn=json_data.get("SourceEntityArn"),
            DataSetArns=json_data.get("DataSetArns"),
            Description=json_data.get("Description"),
            ThemeArn=json_data.get("ThemeArn"),
...
# work around possible type aliasing issues when variable has same name as a model
_DashboardVersion = DashboardVersion
...
class DashboardError(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DashboardError"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DashboardError"]:
        if not json_data:
            return None
        return cls(
            Type=json_data.get("Type"),

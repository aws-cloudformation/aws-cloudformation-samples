...
@dataclass
class AwsSagemakerModelbiasjobdefinition(BaseModel):
    JobDefinitionArn: Optional[str]
    JobDefinitionName: Optional[str]
    ModelBiasBaselineConfig: Optional["_ModelBiasBaselineConfig"]
    ModelBiasAppSpecification: Optional["_ModelBiasAppSpecification"]
    ModelBiasJobInput: Optional["_ModelBiasJobInput"]
    ModelBiasJobOutputConfig: Optional["_MonitoringOutputConfig"]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsSagemakerModelbiasjobdefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsSagemakerModelbiasjobdefinition"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            ModelBiasBaselineConfig=ModelBiasBaselineConfig._deserialize(json_data.get("ModelBiasBaselineConfig")),
            ModelBiasAppSpecification=ModelBiasAppSpecification._deserialize(json_data.get("ModelBiasAppSpecification")),
            ModelBiasJobInput=ModelBiasJobInput._deserialize(json_data.get("ModelBiasJobInput")),
            ModelBiasJobOutputConfig=MonitoringOutputConfig._deserialize(json_data.get("ModelBiasJobOutputConfig")),
...
_AwsSagemakerModelbiasjobdefinition = AwsSagemakerModelbiasjobdefinition
...
class ModelBiasBaselineConfig(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ModelBiasBaselineConfig"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ModelBiasBaselineConfig"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ModelBiasBaselineConfig = ModelBiasBaselineConfig
...
class ModelBiasAppSpecification(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ModelBiasAppSpecification"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ModelBiasAppSpecification"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ModelBiasAppSpecification = ModelBiasAppSpecification
...
class ModelBiasJobInput(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ModelBiasJobInput"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ModelBiasJobInput"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ModelBiasJobInput = ModelBiasJobInput

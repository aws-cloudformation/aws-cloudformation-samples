...
@dataclass
class AwsSagemakerModelqualityjobdefinition(BaseModel):
    JobDefinitionArn: Optional[str]
    JobDefinitionName: Optional[str]
    ModelQualityBaselineConfig: Optional["_ModelQualityBaselineConfig"]
    ModelQualityAppSpecification: Optional["_ModelQualityAppSpecification"]
    ModelQualityJobInput: Optional["_ModelQualityJobInput"]
    ModelQualityJobOutputConfig: Optional["_MonitoringOutputConfig"]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsSagemakerModelqualityjobdefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsSagemakerModelqualityjobdefinition"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            ModelQualityBaselineConfig=ModelQualityBaselineConfig._deserialize(json_data.get("ModelQualityBaselineConfig")),
            ModelQualityAppSpecification=ModelQualityAppSpecification._deserialize(json_data.get("ModelQualityAppSpecification")),
            ModelQualityJobInput=ModelQualityJobInput._deserialize(json_data.get("ModelQualityJobInput")),
            ModelQualityJobOutputConfig=MonitoringOutputConfig._deserialize(json_data.get("ModelQualityJobOutputConfig")),
...
_AwsSagemakerModelqualityjobdefinition = AwsSagemakerModelqualityjobdefinition
...
class ModelQualityBaselineConfig(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ModelQualityBaselineConfig"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ModelQualityBaselineConfig"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ModelQualityBaselineConfig = ModelQualityBaselineConfig
...
class ModelQualityAppSpecification(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ModelQualityAppSpecification"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ModelQualityAppSpecification"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ModelQualityAppSpecification = ModelQualityAppSpecification
...
class ModelQualityJobInput(BaseModel):
    ...
    GroundTruthS3Input: Optional["_MonitoringGroundTruthS3Input"]

    @classmethod
    def _deserialize(
        cls: Type["_ModelQualityJobInput"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ModelQualityJobInput"]:
        if not json_data:
            return None
        return cls(
            ...
            GroundTruthS3Input=MonitoringGroundTruthS3Input._deserialize(json_data.get("GroundTruthS3Input")),
        )


# work around possible type aliasing issues when variable has same name as a model
_ModelQualityJobInput = ModelQualityJobInput
...
class EndpointInput(BaseModel):
    ...
    StartTimeOffset: Optional[str]
    EndTimeOffset: Optional[str]
    InferenceAttribute: Optional[str]
    ProbabilityAttribute: Optional[str]
    ProbabilityThresholdAttribute: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ProbabilityThresholdAttribute=json_data.get("ProbabilityThresholdAttribute"),
        )
...
class MonitoringGroundTruthS3Input(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MonitoringGroundTruthS3Input"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MonitoringGroundTruthS3Input"]:
        if not json_data:
            return None
        return cls(
            S3Uri=json_data.get("S3Uri"),
...
# work around possible type aliasing issues when variable has same name as a model
_MonitoringGroundTruthS3Input = MonitoringGroundTruthS3Input

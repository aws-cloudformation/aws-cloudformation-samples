...
@dataclass
class AwsDatasyncLocationfsxlustre(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsDatasyncLocationfsxlustre"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsDatasyncLocationfsxlustre"]:
        if not json_data:
            return None
...
_AwsDatasyncLocationfsxlustre = AwsDatasyncLocationfsxlustre

...
@dataclass
class AwsVpclatticeAccesslogsubscription(BaseModel):
    Arn: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsVpclatticeAccesslogsubscription"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsVpclatticeAccesslogsubscription"]:
        if not json_data:
            return None
...
_AwsVpclatticeAccesslogsubscription = AwsVpclatticeAccesslogsubscription

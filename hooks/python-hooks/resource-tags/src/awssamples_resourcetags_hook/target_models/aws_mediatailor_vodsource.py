...
@dataclass
class AwsMediatailorVodsource(BaseModel):
    Arn: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsMediatailorVodsource"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsMediatailorVodsource"]:
        if not json_data:
            return None
...
_AwsMediatailorVodsource = AwsMediatailorVodsource

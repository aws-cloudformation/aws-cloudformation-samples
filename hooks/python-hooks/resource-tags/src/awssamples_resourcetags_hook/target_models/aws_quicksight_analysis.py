...
@dataclass
class AwsQuicksightAnalysis(BaseModel):
    AnalysisId: Optional[str]
    Arn: Optional[str]
    AwsAccountId: Optional[str]
    CreatedTime: Optional[str]
    DataSetArns: Optional[Sequence[str]]
    Definition: Optional["_AnalysisDefinition"]
    Errors: Optional[Sequence["_AnalysisError"]]
    ...
    SourceEntity: Optional["_AnalysisSourceEntity"]
    Status: Optional[str]
    Tags: Optional[Any]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsQuicksightAnalysis"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsQuicksightAnalysis"]:
        if not json_data:
            return None
        dataclasses = {n: o for n, o in getmembers(sys.modules[__name__]) if isclass(o)}
        recast_object(cls, json_data, dataclasses)
        return cls(
            AnalysisId=json_data.get("AnalysisId"),
            Arn=json_data.get("Arn"),
            AwsAccountId=json_data.get("AwsAccountId"),
            CreatedTime=json_data.get("CreatedTime"),
            DataSetArns=json_data.get("DataSetArns"),
            Definition=AnalysisDefinition._deserialize(json_data.get("Definition")),
            Errors=deserialize_list(json_data.get("Errors"), AnalysisError),
            ...
            SourceEntity=AnalysisSourceEntity._deserialize(json_data.get("SourceEntity")),
...
_AwsQuicksightAnalysis = AwsQuicksightAnalysis
...
class AnalysisDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AnalysisDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AnalysisDefinition"]:
        if not json_data:
            return None
        return cls(
...
class AnalysisError(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AnalysisError"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AnalysisError"]:
        if not json_data:
            return None
        return cls(
            Type=json_data.get("Type"),
...
class AnalysisSourceEntity(BaseModel):
    SourceTemplate: Optional["_AnalysisSourceTemplate"]

    @classmethod
    def _deserialize(
        cls: Type["_AnalysisSourceEntity"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AnalysisSourceEntity"]:
        if not json_data:
            return None
        return cls(
            SourceTemplate=AnalysisSourceTemplate._deserialize(json_data.get("SourceTemplate")),
        )


# work around possible type aliasing issues when variable has same name as a model
_AnalysisSourceEntity = AnalysisSourceEntity
...
class AnalysisSourceTemplate(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AnalysisSourceTemplate"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AnalysisSourceTemplate"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AnalysisSourceTemplate = AnalysisSourceTemplate

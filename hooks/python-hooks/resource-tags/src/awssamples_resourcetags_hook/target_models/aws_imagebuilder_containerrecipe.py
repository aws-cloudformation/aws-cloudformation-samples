...
@dataclass
class AwsImagebuilderContainerrecipe(BaseModel):
    Arn: Optional[str]
    Name: Optional[str]
    ...
    DockerfileTemplateData: Optional[str]
    DockerfileTemplateUri: Optional[str]
    PlatformOverride: Optional[str]
    ContainerType: Optional[str]
    ImageOsVersionOverride: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsImagebuilderContainerrecipe"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsImagebuilderContainerrecipe"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            DockerfileTemplateData=json_data.get("DockerfileTemplateData"),
            DockerfileTemplateUri=json_data.get("DockerfileTemplateUri"),
            PlatformOverride=json_data.get("PlatformOverride"),
            ContainerType=json_data.get("ContainerType"),
            ImageOsVersionOverride=json_data.get("ImageOsVersionOverride"),
...
_AwsImagebuilderContainerrecipe = AwsImagebuilderContainerrecipe

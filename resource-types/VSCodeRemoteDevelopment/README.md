...
In this code repository, make a copy of `.vscode/settings.template.json`, name it `settings.json` and set your SSH URI (e.g. `ssh://ec2-user@ec2-example-do-not-use.compute-1.amazonaws.com`) for `docker.host`. 
